...
//@interface AcsTestObject : NSObject
//@end

@interface AcsTestObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AcsTestObject class]])
		{
			for (NSString *key in [[(AcsTestObject*)o modules] allKeys])
			{
