...
// in simulator we redefine to format for AcsTest Developer console
...
{\
	NSString * exceptionName = [@"org.acstest." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.acstest";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAcsTestNativeItemNone = -1, 
	UIAcsTestNativeItemSpinner = -2,
	UIAcsTestNativeItemProgressBar = -3,
	
	UIAcsTestNativeItemSlider = -4,
	UIAcsTestNativeItemSwitch = -5,
	UIAcsTestNativeItemMultiButton = -6,
	UIAcsTestNativeItemSegmented = -7,
	
	UIAcsTestNativeItemTextView = -8,
	UIAcsTestNativeItemTextField = -9,
	UIAcsTestNativeItemSearchBar = -10,
	
	UIAcsTestNativeItemPicker = -11,
	UIAcsTestNativeItemDatePicker = -12,
	
	UIAcsTestNativeItemInfoLight = -13,
	UIAcsTestNativeItemInfoDark = -14,
	
	UIAcsTestNativeItemDisclosure = -15,
	
	UIAcsTestNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AcsTest instances of
